...
$(function() {
	...
	var secondList = $(".secondList input");
	...
	secondList.change(function() {
		$("#sencond_appoint").get(0).checked = true;
	...
	minList.change(function() {
		$("#min_appoint").get(0).checked = true;
	...
	hourList.change(function() {
		$("#hour_appoint").get(0).checked = true;
	...
	dayList.change(function() {
		$("#day_appoint").get(0).checked = true;
	...
	mouthList.change(function() {
		$("#mouth_appoint").get(0).checked = true;
	...
	weekList.change(function() {
		$("#week_appoint").get(0).checked = true;
