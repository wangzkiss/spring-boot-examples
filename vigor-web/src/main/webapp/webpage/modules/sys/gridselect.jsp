...
<body class="gray-bg">
	...
	<div class="row">
	<div class="col-sm-12">
		<form:form id="searchForm" modelAttribute="obj" action="${url}" method="post" class="form-inline pull-left">
		...
		<a  class="btn btn-success btn-rounded btn-outline btn-sm filterReset" onclick="reset()" ><i class="fa fa-refresh"></i> 重置</a>
	...
	<table id="contentTable" class="table table-bordered table-hover table-condensed dataTables-example dataTable">
		<thead>
			<tr>
				<th><!-- <input type="radio" class="i-checks"> --></th>
		...
		<c:forEach items="${page.list}" var="obj">
			<tr>
				<td> <input type="radio" name="values" id="${fns:getValue(obj, 'id')}" class="i-checks"></td>
