...
<body>
	<style>
		...
		.ibox-content{padding:0; height: 300px; overflow: auto;}
	</style>
	<div class="form-padding">
	<div id="assignRole" class="row">
		<div class="col-sm-4">
			<div class="ibox">
				<div class="ibox-title"><h5>所在部门</h5></div>
		...
		<div class="col-sm-4">
			<div class="ibox">
				<div class="ibox-title"><h5>待选人员</h5></div>
				<div class="ibox-content">
		...
		<div class="col-sm-4">
			<div class="ibox">
				<div class="ibox-title"><h5>已选人员</h5></div>
				<div class="ibox-content">
