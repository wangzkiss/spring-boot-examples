...
<head>
    ...
    <style type="text/css">
		...
		.the-icons li {float:left;width:31%;line-height:25px;margin:2px 5px;cursor:pointer;}
...
<div id="icons">
				<h2 class="page-header">自定义图标</h2>
				<ul class="the-icons">
					<li class="fa-hover col-md-3 col-sm-4"><i class="fa myicon-set1"></i> 三级图标</li>
