<%@ page contentType="text/html;charset=UTF-8" %><meta http-equiv="Content-Type" content="text/html;charset=utf-8" /><meta name="author" content="http://www.tospur.org/"/>
...
<script src="${ctxStatic}/jquery-validation/1.14.0/localization/methods.js" type="text/javascript"></script>
...
<script src="${ctxStatic}/lodash.js"></script>
<script src="${ctxStatic}/ace/assets/js/date-time/moment.js"></script>
