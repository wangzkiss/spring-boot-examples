...
<%@ attribute name="hideType" type="java.lang.String" required="false" description="显示类型"%>
<!-- 0:隐藏tip, 1隐藏box,不设置显示全部 -->
<%@ attribute name="content" type="java.lang.String" required="true" description="消息内容"%>
<%@ attribute name="type" type="java.lang.String" description="消息类型：info、success、warning、error、loading 、danger"%>
...
<c:if test="${not empty content}">
	...
	<c:if test="${empty type}">
		<c:set var="ctype" value="${fn:indexOf(content,'成功') eq -1?'warning':'success'}"/>
	</c:if>
