...
<button class="btn btn-white btn-sm toolbar" onclick="deleteAll()" style="padding: 8px 10px" data-toggle="tooltip" data-placement="top"><i class="fa fa-trash-o"> ${label==null?'删除':label}</i>
                        </button>
