...
import cn.vigor.common.security.Digests;
import cn.vigor.common.security.shiro.session.SessionDAO;
import cn.vigor.common.service.BaseService;
import cn.vigor.common.service.ServiceException;
import cn.vigor.common.utils.CacheUtils;
import cn.vigor.common.utils.Encodes;
import cn.vigor.common.utils.StringUtils;
import cn.vigor.modules.sys.dao.ActUserDao;
import cn.vigor.modules.sys.dao.MenuDao;
import cn.vigor.modules.sys.dao.RoleDao;
import cn.vigor.modules.sys.dao.UserDao;
import cn.vigor.modules.sys.entity.Menu;
...
import cn.vigor.modules.sys.utils.LogUtils;
...
public class SystemService extends BaseService implements InitializingBean {
	...
	public void saveUser(User user) {
		if (StringUtils.isBlank(user.getId())){
            ...
            user.setId(id);
            actDao.insertActUser(user);
            actDao.insertActUserShip(user);
         
            //删除已存在的id
            
            userDao.deleteEtlUserById(id);
            user.setId(id);
...
//		systemRealm.clearAllCachedAuthorizationInfo();
	...
	public void deleteUser(User user) {
		...
		actDao.deleteActship(user);
		actDao.deleteActUser(user);
		// 清除用户缓存
		UserUtils.clearCache(user);
//		// 清除权限缓存
//		systemRealm.clearAllCachedAuthorizationInfo();
